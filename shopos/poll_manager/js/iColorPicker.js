...
this.iColorPicker = function () {
    jQuery("input.iColorPicker").each(function (i) {
        ...
        jQuery(this).css("backgroundColor", jQuery(this).val()).after('<a class="color-s" href="javascript:void(null)" id="icp_' + this.id + '" onclick="iColorShow(\'' + this.id + '\',\'icp_' + this.id + '\')">Выбрать</a>')
    })
};
jQuery(function () {
    iColorPicker()
